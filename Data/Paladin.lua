...
function Chronometer:PaladinSetup()
	...
	self:AddTimer(self.EVENT, "Holy Might",        20, 0,1,1, { cr="YELLOW", a=1 })
	self:AddTimer(self.EVENT, "Zeal",        30, 0,1,1, { cr="ORANGE", a=1 })
	...
	self:AddTimer(self.EVENT, BS["Vengeance"],                  30, 0,1,1, { cr="WHITE", a=1 })
