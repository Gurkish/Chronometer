...
--                kind,       name,                  duration, targeted, isgain, selforselect, extra
	...
	self:AddTimer(self.SPELL, BS["Tiger's Fury"],           6, 0,1,1, { rc=true, d={tn=BS["Blood Frenzy"], tb=6}  }) -- turtle WOW
	...
	self:AddTimer(self.EVENT, "Nature Eclipse",        15, 0,1,1, { cr="GREEN", a=1 })
	self:AddTimer(self.EVENT, "Arcane Eclipse",        15, 0,1,1, { cr="BLUE", a=1 })
	...
	self:AddTimer(self.EVENT, BS["Blood Frenzy"],          6, 0,1,1, { d={tn=BS["Blood Frenzy"], tb=6}, a=1 }) -- turtle WOW
end
